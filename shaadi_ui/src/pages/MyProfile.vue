    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="flex items-center justify-between mb-8">
        ...
        <div v-if="profile" class="text-right">
          ...
          <div class="text-2xl font-bold text-purple-600">{{ profile.profile_completeness || 0 }}%</div>
        </div>
      </div>
      ...
      <div v-else-if="profile" class="space-y-6">
        ...
        <Card class="bg-gradient-to-r from-purple-600 to-pink-600 text-white">
          <div class="flex items-center justify-between">
            <div>
              <h2 class="text-2xl font-bold mb-2">{{ subscriptionData?.plan_details?.plan_name || 'No Active Plan' }}</h2>
              <p class="text-purple-100" v-if="subscriptionData?.days_remaining">{{ subscriptionData.days_remaining }} days remaining</p>
              <p class="text-purple-100" v-else>No active subscription</p>
            </div>
        ...
        <Card>
          <template #header>
            <div class="flex items-center justify-between">
              <h2 class="text-xl font-semibold text-gray-900">Identity & Culture</h2>
        ...
        <Card>
          <template #header>
            <div class="flex items-center justify-between">
              <h2 class="text-xl font-semibold text-gray-900">Physical Attributes</h2>
        ...
        <Card>
          <template #header>
            <div class="flex items-center justify-between">
              <h2 class="text-xl font-semibold text-gray-900">Education & Career</h2>
